...
function Header() {
  ...
  const [isStartActive, setIsStartActive] = useState('svgIsActive');
  const [isRewardsActive, setIsRewardsActive] = useState('svgIsOff');

  useEffect(() => {
    const changeStateOfSVG = () => {
      if (location.pathname == '/rewards') {
        setIsRewardsActive('svgIsActive');
        setIsStartActive('svgIsOff');
        console.log('first if is works', location);
      } else {
        setIsStartActive('svgIsActive');
        setIsRewardsActive('svgIsOff');
  ...
  return (
    <header className="ContainerStyles__ContainerStyle-sc-s3zvez-0 jZXtRO sc-10caba54-0 hdhJEX">
      <div className="sc-10caba54-1 OxIOs">
        <div className="LidoLogoStyles-sc-fifpqw-0 lcaCNs">
      ...
      <div className="sc-9a13c5a1-0 dXUYPd">
        <Link to={'/'} className="sc-9a13c5a1-1 lovFKf">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
            fill="currentColor"
            className={isStartActive}>
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
        ...
        <Link to={'/rewards'} className="sc-9a13c5a1-1 pSWez">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
            fill="currenretColor"
            className={isRewardsActive}>
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
      ...
      <div className="sc-10caba54-2 iyCGYJ">
        <button type="button" className="ButtonStyles__ButtonStyle-sc-gzfh1w-0 kehQmq">
          <span className="ButtonStyles__ButtonContentStyle-sc-gzfh1w-2 kdqiBT">
            Connect wallet
          </span>
        </button>
        {/* Night mode */}
        {/* <button
          type="button"
          className="ButtonStyles__ButtonStyle-sc-gzfh1w-0 fozxxf sc-da274e2e-0 OwrAb">
          <span className="ButtonStyles__ButtonContentStyle-sc-gzfh1w-2 kdqiBT">
